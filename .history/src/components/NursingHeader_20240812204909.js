    ...
    <div id="NursingHeader" className="container-fluid">
      <div className="row">
        ...
        <div className="col-md-6" style={{ textAlign: "right" }}>
           ...
           <img src="../assets/info-button.png" style={{ width: "25px", height: "25px" }} alt="ADD" /> 
           <img src="../assets/refresh.png" style={{ width: "25px", height: "25px" }} alt="ADD" /> 
           <img src="../assets/printer.png" style={{ width: "25px", height: "25px" }} alt="ADD" /> 
           <img src="../assets/folder.png" style={{ width: "25px", height: "25px" }} alt="ADD" /> 
